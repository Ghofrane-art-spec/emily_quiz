...
<body>
    ...
    <?php
    $a=$_SESSION['result'];
    echo("you result is ".$a."  you have to watch the show again dude");
    ?>
    <br><br>
    <img src="https://cdn-europe1.lanmedia.fr/var/europe1/storage/images/europe1/medias-tele/emily-in-paris-la-serie-netflix-cree-la-discorde-apres-une-blague-sur-la-pizza-3997261/56119619-1-fre-FR/Emily-in-Paris-la-serie-Netflix-cree-la-discorde-apres-une-blague-sur-la-pizza.png" alt="300dp" width="400dp"><br>
    <br><br>
